      ...
      <div className="px-4 md:px-8 lg:px-10 py-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Link to="/reports">
            ...
            <button
              className="px-6 py-3 rounded-2xl border-2 border-blue-600 text-blue-600 font-semibold hover:bg-blue-50 transition duration-300 shadow-sm"
            >
              Export
            </button>
...
<button
    ...
    className="px-6 py-3 rounded-2xl bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold shadow-lg hover:scale-105 hover:shadow-orange-300 transition duration-300"
>
    Generate Report
</button>
          </Link>
